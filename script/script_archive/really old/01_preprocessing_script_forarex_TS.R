...
setwd('/home/taco/Documents/greta_forarex/data/control/raw_bodenkontrolle/_Bodenkontrolle')
...
all_csvs = read.table(csv_list[1], header = T, sep = ',')
